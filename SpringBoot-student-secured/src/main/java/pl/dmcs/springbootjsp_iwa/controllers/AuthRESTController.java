...
import pl.dmcs.springbootjsp_iwa.controllers.StudentRESTController;
...
public class AuthRESTController {
    ...
    @Autowired
    public AuthRESTController(DaoAuthenticationProvider daoAuthenticationProvider, UserRepository userRepository, StudentRepository studentRepository, RoleRepository roleRepository, PasswordEncoder passwordEncoder, JwtProvider jwtProvider) {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignUpForm signUpRequest) {
        ...
        // Create user account
        //Student student = new Student(signUpRequest.getFirstname(), signUpRequest.getLastname(),signUpRequest.getEmail(), signUpRequest.getTelephone());
        ...
        Student student = signUpRequest.getStudent();
